...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("All products before filtering method (" + demoSearchHit.getProducts().size() + " hits):");
        ...
        System.out.println("Products found with filtering method (" + filteredSearchHit.getProducts().size() + " hits):");
